        ...
        <div className='row mt-2'>
                                ...
                                <li key={index} className='list-group-item'>
                                    ...
                                    <div className='d-flex align-items-top justify-content-between mb-0 '>
                                        <div className='d-flex'>
                                            <div className=''>
                                                <img src='https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSzIdr7HcfjPdwSAGPtaGRxlaM7d-PaAJdX9Q&s' width={'45px'} className='rounded-circle border border-2' />
                                            </div>
                                            <div className='d-flex flex-column ms-3'>
                                                ...
                                                <div className='d-flex'>
                                                    {[...Array(5)].map((_, index) => (
                                                        <i
                                                            key={index}
                                                            className={`text-warning bi ${index < review.rating ? "bi-star-fill" : "bi-star"
                                                                }`}
                                                        ></i>
                                                    ))}
                                                </div>
                                    ...
                                    <div className='mt-2'>
                                        <p className='' style={{ fontFamily: 'serif' }}>{review.review}</p>
                                    </div>
            ...
            <div className='col-12 col-md-4 border-start' id='add-review-col'>
                ...
                <div className='d-flex flex-column p-4'>
                    ...
                    <button type="button" className="btn btn-dark rounded-pill mb-2" data-bs-toggle="modal" data-bs-target="#AddReviewModal">Add Review</button>
                </div>


                <div className="modal fade" id="AddReviewModal" tabIndex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div className="modal-dialog">
                        <div className="modal-content">
                            ...
                            <div className="modal-body">
                                <form onSubmit={handleSubmitReview} className="bg-light p-3 rounded shadow-sm">
                                    <div className="mb-3">
